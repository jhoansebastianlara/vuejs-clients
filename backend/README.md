...
## API documentation
I used swagger to document the API. See the documentation [here](https://github.com/jhoansebastianlara/vuejs-clients/blob/master/backend/src/api/swagger/swagger.yaml). (see also in swaggerhub: [here](https://app.swaggerhub.com/api/jhoansebastianlara/web-clients/1.0.0))
